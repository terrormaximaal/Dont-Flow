        ...
        sections: [
            {
                splitAfterLane: 0,
                gate: [ 0, 1 ],
                rows: [ '1..', '.2.', '..3', '1.2', '.3.', '2..', '..1', '.2.', '3..', '..2', '1.3', '.1.', '..3', '2..' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 1, 2 ],
            ...
            },
            {
                splitAfterLane: 1,
                gate: [ 2, 0 ],
                rows: [ '..3', '1..', '.3.', '..1', '3..', '.1.', '1.3', '..3', '.1.', '3..', '..1', '.3.', '1..', '..3' ]
            },
            {
                splitAfterLane: 0,
                gate: [ 0, 2 ],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                gate: [ 1, 0 ],
                obstacles: 'static',
                rows: [ '..2', 'a..', '.1.', '..2', '.b.', '1..', '..1', 'a..', '.2.', '..2', '.a.', '2..', '..1', '.b.' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 0, 2 ],
            ...
            },
            {
                ...
                gate: [ 2, 0 ],
                obstacles: 'static',
                rows: [ '..3', '.1.', 'c..', '..1', '.a.', '3..', '..3', 'c..', '.1.', '..a', '3..', '.3.', '..1', 'c..' ]
            }
        ]
    },
    {
        ...
        sections: [
            {
                ...
                gate: [ 0, 1 ],
                obstacles: 'static',
                rows: [ '1..', '.b.', '..1', '2..', '.a.', '..2', '1.b', '..1', 'a..', '.2.', '..b', '1..', '.1.', 'b..', '..2' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 1, 2 ],
            ...
            },
            {
                ...
                gate: [ 2, 0 ],
                obstacles: 'static',
                rows: [ '..3', '.a.', '1..', '..1', 'c..', '.3.', '..a', '1..', '.1.', '..c', '3..', '.a.', '..3', '1..', '.c.' ]
            },
            {
                splitAfterLane: 0,
                gate: [ 0, 2 ],
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                gate: [ 1, 2 ],
                obstacles: 'slider',
                rows: [ '.2.', '..3', 'a..', '.3.', '..2', 'd..', '.2.', '..3', 'a..', '.3.', '..2', 'd..', '.3.', '..2', 'a..' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 2, 3 ],
            ...
            },
            {
                ...
                gate: [ 3, 0 ],
                obstacles: 'slider',
                rows: [ '4..', '..1', '.b.', '4..', '..4', 'c..', '.1.', '..4', '.c.', '1..', '..1', 'b..', '.4.', '..1', '.b.' ]
            }
        ]
    },
    {
        ...
        sections: [
            {
                splitAfterLane: 0,
                gate: [ 0, 1 ],
                rows: [ '1..', '.2.', '..3', '1.2', '.3.', '2..', '..1', '.3.', '2..', '..2', '1.3', '.1.', '..3', '2..' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 1, 2 ],
            ...
            },
            {
                ...
                gate: [ 2, 3 ],
                obstacles: 'static',
                rows: [ '..3', '.4.', 'b..', '..4', '.3.', 'a..', '..3', '.4.', 'b..', '..3', '.a.', '4..', '..4', '.3.' ]
            },
            {
                splitAfterLane: 0,
                gate: [ 3, 0 ],
            ...
            },
            {
                ...
                gate: [ 0, 2 ],
                obstacles: 'static',
                rows: [ '1..', '..3', '.b.', '1..', '..1', 'd..', '.3.', '..1', '.d.', '3..', '..3', 'b..', '.1.', '..3' ]
            }
        ]
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                gate: [ 3, 0 ],
                obstacles: 'static',
                rows: [ '4..', '..1', '.c.', '4..', '..4', 'b..', '.1.', '..4', '.b.', '1..', '..1', 'c..', '.4.', '..1', '.c.' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 0, 3 ],
        ...
        sections: [
            {
                splitAfterLane: 0,
                gate: [ 0, 1 ],
                rows: [ '1..', '.2.', '..3', '1.2', '.3.', '2..', '..1', '.2.', '3..', '..2', '1.3', '.1.', '..3', '2..', '.1.', '..2' ]
            },
            {
                splitAfterLane: 1,
                gate: [ 1, 2 ],
            ...
            },
            {
                ...
                gate: [ 2, 3 ],
                obstacles: 'pulse',
                rows: [ '..3', '.4.', 'b..', '..4', '.3.', 'a..', '..3', '.4.', 'e..', '..3', '.a.', '4..', '..4', '.3.', 'b..', '..4' ]
            },
            {
                splitAfterLane: 0,
                gate: [ 3, 4 ],
            ...
            },
            {
                ...
                gate: [ 4, 0 ],
                obstacles: 'slider',
                rows: [ '5..', '..1', '.c.', '5..', '..5', 'd..', '.1.', '..5', '.d.', '1..', '..1', 'c..', '.5.', '..1', '.c.', '5..' ]
            }
        ]
    }
];
